-- PART 1 : CREATE 9 TABLES FOR VIDEOS GAMES
...
SELECT TITLE.TITLE_NAME, CHARACTER.ACTOR_NAME, CHARACTER.CHARACTER_NAME
    FROM TITLE INNER JOIN ([CHARACTER] INNER JOIN [TITLE_TO_CHARACTER] ON CHARACTER.CHARACTER_ID = [TITLE_TO_CHARACTER].CHARACTER_ID) ON TITLE.TITLE_ID = [TITLE_TO_CHARACTER].TITLE_ID;